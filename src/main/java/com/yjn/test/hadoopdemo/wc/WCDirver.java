package com.yjn.test.hadoopdemo.wc;
...
public class WCDirver {
	public static void main(String[] args)
		 ...
		 * URI("hdfs://192.168.116.10:9000/"), new Configuration(), "root");
		 */
		...
		// hadoop jar hdfs.jar com.sitech.hadoop.mr.wordcount.WCDirver
		// /wdcount/input /wdcount/output
	}
}
